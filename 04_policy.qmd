...
@ghaffarian2018 has provided a review on proxy parameters for disaster risk that can be extracted from satellite imagery. These include building height and material for vulnerablity against earthquakes, road network analysis for assessment of transport networks, and flood water levels and debris detection for flood risk assessment. @rong2020 has used DSM data for hydrodyanamic simulation of flood risks. 
...
Vegetation
Elevation models
Informal settlements are the hardest to do
